	...
	gameData = {
		...
		//Generator Upgrades
			...
			requirements : {
				generatorLevel : [0, 0, 0, 0, 0, 1, 0, 2, 0, 3],
				red :   [20, 0, 0, 0, 0, 0],
				green : [0, 5, 25, 50, 250, 50000, 150000, 0],
				blue :  [0, 5, 25, 50, 250, 50000, 150000, 0],
			},
			cost : {
				red : [0, 5, 25, 50, 250, 50000, 150000, 0],
				energy : [50e-9, 750e-9, 50e-6, 1000e-6, 10e-3, 100e3, 2e6, 0],
				light : [0, 0, 0, 0, 0, 500e-9, 5e-6],
			},
			target : "red",
			max : 9
		},{
			...
			cost : {
				...
				energy : [10e3, 1e6, 10e6, 10e9, 10e12]
			},
			max : 5
		},{
			class : GeneratorUpgrade,
